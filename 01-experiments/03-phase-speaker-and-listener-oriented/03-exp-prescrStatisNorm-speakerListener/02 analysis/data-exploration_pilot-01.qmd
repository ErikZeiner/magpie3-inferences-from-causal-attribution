...
df1 <- as_tibble(read.csv('../01 data/results_pilot-01.csv'))
...
speaker_conditions <- read.csv('speaker_conditions_pilot-01.csv', stringsAsFactors = FALSE)
listener_conditions <- read.csv('listener_conditions_pilot-01.csv', stringsAsFactors = FALSE)
